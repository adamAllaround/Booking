...
@Import({DatabaseConfig.class, EventsConfig.class, OwnersConfig.class, ItemsConfig.class, BookingsConfig.class, LoggingConfig.class, NotificationsConfig.class})
